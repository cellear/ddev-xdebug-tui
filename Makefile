...
#   2. ddev get /absolute/path/to/ddev-xdebug-tui # Install add-on into DDEV project
#   3. ddev debug                                  # Launch the debugger
#
...
install: build
	...
	@echo "Ensure ~/go/bin is in your PATH for 'ddev debug' to work"
